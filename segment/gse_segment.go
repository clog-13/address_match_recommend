...
func NewGseSegment() gse.Segmenter {
	//g := new(GseSegment)
	g, err := gse.New("zh_s,C:\\Users\\zx\\GolandProjects\\address_match_recommend\\resource\\dic\\community.dic,C:\\Users\\zx\\GolandProjects\\address_match_recommend\\resource\\dic\\region.dic") // 加载默认词典
